            ...
            <div class="form-container">
                ...
                <form id="update-form" data-id="${newsId}">
                    <div class="form-group">
                        ...
                        <input class="form-input" type="text" id="update-title" name="title" value="${newsItem.title}" required>
                    </div>
                    <div class="form-group">
                        <label for="update-description">Description</label>
                        <textarea class="form-textarea" id="update-description" name="description" rows="4" required>${newsItem.description}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="editor-group">
                        <div class="editor-input-group">
                            ...
                            <input class="form-input" type="text" id="update-editorFirstname" name="editorFirstname" value="${newsItem.editorFirstName}" required>
                        </div>
                        <div class="editor-input-group">
                            <label for="update-editorLastname">Editor Last Name</label>
                            <input class="form-input" type="text" id="update-editorLastname" name="editorLastname" value="${newsItem.editorLastName}" required>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="button" class="cancel-update form-button">Cancel</button>
                        <button type="submit" class="form-button save-button">Update</button>
                    </div>
                </form>
            </div>
        </div>
...
async function updateNews(event) {
    ...
    try {
        ...
        fetchNews();
        document.querySelector('.add-news-main').remove(); 
    } catch (error) {
